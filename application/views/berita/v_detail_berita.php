    ...
    <div class="col-md-12">
      <div class="row">
        <div class="col-md-12">
          ...
          <!-- <div class="col-md-4"> -->
          <h6>Kategori : <p class="badge badge-success px-1 py-2" style="text-transform:uppercase;">
              <?= $berita->rubrik ?></p>
          </h6>
          <h6 class="float-left">Tgl Buat&ensp;: </h6>
          <p for="" class="float-left">&ensp;&ensp;<i class="fa fa-calendar">&ensp;</i><?= $berita->tgl_berita ?></p>
          <br><br>
        ...
        <div class="col-md-12 mt-3">
          ...
          <div class="col-md-12">
            ...
            <h5>Diskusi:</h5>
            <textarea id="komen" name="komen" rows="2" placeholder="Tuliskan Komentar Anda. . ."
              class="form-control mt-2" style="" required></textarea>
          ...
          <div class="col-md-12 ml-4 mt-4">
            ...
            <img class="float-left rounded-circle" src="<?= base_url("$value->foto_file") ?>" alt="" width="50"
              height="50">
            ...
            <button id="btnreply" onclick="balas('<?= $value->nama ?>')" href="#" class=""
              style="margin-top:-15px; margin-left:70px;">Reply</button><br><br>
            <hr>
            <?php } ?>
          </div>
        </div>
