<div class="card">
  <ul class="nav nav-tabs mb-3" id="pills-tab" role="tablist">
    ...
    <li class="nav-item">
      <a class="nav-link disabled" id="pills-dua-tab" data-toggle="pill" href="#pills-dua" role="tab"
        aria-controls="pills-dua" aria-selected="false">Data Kelahiran</a>
    </li>
    <li class="nav-item">
      <a class="nav-link disabled" id="pills-tiga-tab" data-toggle="pill" href="#pills-tiga" role="tab"
      ...
      <div class="form-row col-md-12">
        ...
        <div class="form-group col-md-2">
          ...
          <select class="form-control" name="dusun">
            <option value="tinjumoyo">Tinjumoyo</option>
            <option value="tonggolari">Tonggolari</option>
            <option value="sukorembug">Sukorembug</option>
          </select>
        </div>
    ...
    <div class="tab-pane fade" id="pills-tiga" role="tabpanel" aria-labelledby="pills-tiga-tab">
      <div class="form-row col-md-12">
        ...
        <div class="form-group col-md-6">
          ...
          <input class="form-control" type="text" name="ketpengantar" placeholder="Keterangan Surat Pengantar"
            required />
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
          <label for="" class="control-label">Keterangan Fotokopi Surat Kelahiran <span class="text-danger">*</span>
          </label>
        ...
        <div class="form-group col-md-6">
          <label for="" class="control-label">Fotokopi Buku Nikah / Akta Perkawinan <span class="text-danger">*</span>
          </label>
          <input class="form-control" type="file" name="bukunikah" required />
        </div>
        <div class="form-group col-md-6">
          <label for="" class="control-label">Keterangan <span class="text-danger">*</span> </label>
          <input class="form-control" type="text" name="ketbuku"
            placeholder="Keterangan Fotokopi Buku Nikah / Akta Perkawinan" required />
        </div>
        <div class="form-group col-md-2 offset-md-8">
