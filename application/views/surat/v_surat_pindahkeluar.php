...
<section id="get-started" class="padd-section wow fadeInUp">
  <div class="containers">
    <div class="section-title text-center">
      <h2>Persyaratan Pindah Keluar</h2>
    ...
    <div class="row">
      <div class="col-md-8 offset-md-2">
        <div class="card">
          ...
          <ul class="list-group list-group-flush">
            <li class="list-group-item">1. <b>Surat Keterangan Pindah</b> dari Desa/Kelurahan yang telah dilegalisasi
              oleh Kepala Desa/Lurah;</li>
            <li class="list-group-item">2. <b>Kartu Keluarga (KK)</b> asli;</li>
            <li class="list-group-item">3. <b>Kartu Tanda Penduduk (KTP)</b> asli;</li>
            ...
            <li class="list-group-item">6. <b>Fotocopy Akta Kelahiran</b>;</li>
            <li class="list-group-item">7. Pas Foto</li>
            <li class="list-group-item"> - <b>Pas Foto 3 X 4</b> 4(empat) lembar untuk antar Desa/Kelurahan Kecamatan;
            </li>
            <li class="list-group-item"> - <b>Pas Foto 3 X 4</b> 16(enam belas) lembar untuk antar Kabupaten/Kota;</li>
      ...
      <div class="col-md-12 mt-5">
        ...
        <?php echo form_open_multipart(base_url("surat/pindahkeluar"), array('class' => 'form-horizontal')); ?>
