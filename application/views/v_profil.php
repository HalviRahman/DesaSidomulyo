            ...
            <div class="tab-pane fade show active" id="pills-satu" role="tabpanel" aria-labelledby="pills-satu-tab">
              <div class="form-row col-md-12">
                ...
                <div class="form-group col-md-3">
                  ...
                  <input class="form-control" type="text" name="nama" placeholder="Nama" value="<?= $warga->nama ?>"
                    disabled required>
                </div>
                <div class="form-group col-md-3">
                  <label for="" class="control-label">Email <span class="text-danger">*</span> </label>
                  <input class="form-control" type="email" name="email" placeholder="Email" value="<?= $warga->email ?>"
                    required>
                </div>
                <div class="form-group col-md-3">
                ...
                <div class="form-group col-md-3">
                  <label for="" class="control-label modal-label">Golongan Darah <span class="text-danger">*</span>
                  </label>
                ...
                <div class="form-group col-md-1">
                  ...
                  <input class="form-control" type="text" name="rt" placeholder="RT" value="0<?= $warga->rt ?>"
                    required>
                </div>
                <div class="form-group col-md-3">
