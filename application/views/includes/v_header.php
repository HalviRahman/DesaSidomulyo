  ...
  <header id="header" class="header header-hide">
    <div class="container">
      <div id="logo" class="pull-left">
        <h1><a href="<?= base_url() ?>" class="scrollto"><span>Desa</span> Sidomulyo</a></h1>
      </div>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <?php if (isset($_SESSION['nik'])) : ?>
          <li class="menu-has-children menu"><a href="<?= base_url() ?>surat">Persyaratan Surat</a>
            <ul>
              <!-- <li class="menu-has-children"><a href="<?= base_url() ?>surat">Persyaratan Surat</a> -->
              <!-- <ul> -->
              <li class="menu"><a href="<?= base_url() ?>surat/nikah">Nikah</a></li>
              <li class="menu"><a href="<?= base_url() ?>surat/pindahnikah">Pindah Nikah</a></li>
              <li class="menu"><a href="<?= base_url() ?>surat/kematian">Akta Kematian</a></li>
              <li class="menu"><a href="<?= base_url() ?>surat/santunankematian">Santunan Kematian</a></li>
              <li class="menu"><a href="<?= base_url() ?>surat/ketUsaha">Keterangan Usaha</a></li>
              <li class="menu"><a href="<?= base_url() ?>surat/pindahdatang">Pindah Datang</a></li>
              <li class="menu"><a href="<?= base_url() ?>surat/pindahkeluar">Pindah Keluar</a></li>
              <li class="menu"><a href="<?= base_url() ?>surat/skck">SKCK</a></li>
              <li class="menu"><a href="<?= base_url() ?>surat/pengalihanbpjs">Pengalihan BPJS Mandiri</a></li>
          ...
          <li class="menu-has-children"><a href="<?= base_url() ?>akun/profil" style="text-decoration:none;"><img
                class="" style="width:30px; height:30px; border-radius:100%;" src="<?= base_url($foto) ?>" alt="">&ensp;
              <?= $_SESSION['nama'] ?> </a>
            <ul>
              <li><a href="<?= base_url() ?>akun/profil" style="text-decoration:none;"><i class="fa fa-address-book-o"
                    style="font-size:18px"></i>&ensp; Akun</a></li>
              <!-- <li><a href="<?= base_url() ?>informasi/profil">Ganti Kata Sandi</a></li> -->
              <li><a href="<?= base_url() ?>akun/ganti_pass" style="text-decoration:none;" id="btnkeluar"> Ganti Kata
                  Sandi</a></li>
