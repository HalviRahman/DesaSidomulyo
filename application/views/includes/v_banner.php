<section id="herobanner" class="wow fadeIn text-center">
  <!-- <div id="mobile-title">
    <h1>Welcome to Desa Sidomulyo</h1>
    <h2>Website informasi dan pelayanan Desa Sidomulyo</h2>
  </div> -->
  <div class="hero-container">
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <div class="carousel-caption d-md-block" style="margin-bottom: 280px;">
            <h1 style="
  -webkit-text-stroke-width: 1px;
  -webkit-text-stroke-color: white;">Welcome to Desa Sidomulyo</h1>
