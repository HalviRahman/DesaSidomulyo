  ...
  <div class="container">
      ...
      <div class="col-md-6 col-lg-4">
        <div class="feature-block">
          <a href="<?= base_url("surat") ?>">
            ...
            <h4>Persyaratan Surat</h4>
            <p>Layanan berbagai kebutuhan persyaratan surat warga Desa Sidomulyo.</p>
          </a>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="feature-block">
          <a href="<?= base_url("pengaduan/buat_pengaduan") ?>">
            ...
            <p>Layanan pengaduan keluhan warga Desa Sidomulyo.</p>
          </a>
    ...
    <div class="row pb-5 px-5 mt-3" style="background:rgba(0, 0, 0, 0.8);">
      <div class="col-md-12 pt-3" id="hero" style="height:50px; margin:10px 0 60px 0;">
        ...
        <h2 class="text-light">Informasi mengenai berita dan kegiatan di Desa Sidomulyo.</h2>
      </div>
      <?php foreach ($berita as $key => $value) : $judul = $value->judul; ?>
      <div class="col-md-4 text-left">
        <div id="cardberitah">
          <a href="<?= base_url("berita/detail/$value->judul/$value->id_berita") ?>"><img id="imgberita"
              src="<?= base_url($value->cover_file) ?>" alt="Berita" class=""></a>
          <div id="isiberita" class="">
            <label id="tglberita" style="" for="" class=""><i
                class="fa fa-calendar"></i><?= $value->tgl_berita ?></label><br>
            <a id="judulberita" href="<?= base_url("berita/detail/$value->judul/$value->id_berita") ?>" style=""
              class="" data-toggle="tooltip" title="<?= $judul ?>"><?= substr($judul, 0, 60); ?>...</a><br>
      ...
      <a href="<?= base_url("berita/lihat/semua") ?>" class="btn btn-light text-dark py-2 mx-auto mt-5"
        style="border-radius:50px;">Selengkapnya</a>
    </div>
    <!-- <br><br> -->
    ...
    <!-- <div class="row">
      <div class="col-md-12" id="hero" style="height:50px; margin:10px 0 60px 0; padding:0;">
        ...
        <h2>Berikut daftar aspirasi/keluhan warga Desa Sidomulyo.</h2>
      </div>
        ...
        <div id="cardberitah">
          ...
          <div id="isiberita" class="pl-2" style="text-transform:capitalize;"><br>
            <label id="tglpengaduan" style="" for="" class=""><i class="fa fa-calendar"></i>
              <?= $value->tgl_pengaduan ?></label><br>
            <label for=""><span class="badge badge-info py-2"><?= $value->bidang ?></span>&ensp;<span
                class="badge badge-warning py-2"><?= $value->kategori ?></span> </label><br>
            <a id="judulberita" href="<?= base_url("pengaduan/detail/$value->id_pengaduan") ?>" style="" class=""
      ...
      <?php endforeach; ?>
      <div class="col-md-12"></div>
      <a href="<?= base_url("pengaduan/lihat/semua") ?>" class="btn btn-success py-2 mx-auto mt-5"
        style="border-radius:50px;">Selengkapnya</a>
    </div> -->
