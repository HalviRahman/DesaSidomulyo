          ...
          <div class="content">
            ...
            <div class="row">
              <div class="form-group col-md-4" style="padding-left:0;">
                ...
                <input class="form-control" type="text" name="nik" placeholder="NIK" value="<?= $hasil->nik ?>"
              ...
              <div class="form-group col-md-3">
                ...
                <input class="form-control" type="text" name="nama_terkait" placeholder="Nama"
                  value="<?= $hasil->nama_terkait ?>">
              </div>
              <div class="form-group col-md-6">
                <label for="" class="control-label">Tujuan/Alasan<span class="text-danger">*</span> </label>
                <!-- <input class="form-control" type="text" name="tujuan" placeholder="Tujuan" value="<?= $hasil->tujuan ?>"> -->
                <textarea class="form-control" name="tujuan" placeholder="Tujuan" rows="5" value=""
                  required><?= $hasil->tujuan ?></textarea>
              </div>
              <div class="form-group col-md-6">
                <label for="" class="control-label">Alamat<span class="text-danger">*</span> </label>
                <textarea class="form-control" name="alamat" placeholder="Alamat" rows="5" value=""
                  required><?= $hasil->alamat ?></textarea>
              </div>
              <div class="col-md-12">
