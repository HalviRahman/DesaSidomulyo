        ...
        <table class="table table-hover table-striped table-responsive" id="tbl_baru">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?= $w->nama ?></td>
              <td class="tindakan">
                <a href="<?= base_url("admin/$menu/detail/$w->id_pengaduan") ?>" class="btn btn-info"
                  title="Lihat">Lihat</a>
              </td>
            </tr>
            <?php endforeach; ?>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="tindakan">
                ...
                <button onclick="proses('<?= base_url("admin/$menu/proses/$w->id_pengaduan/2") ?>')"
                  class="btn btn-success" title="Selesai">Selesai</button>
                <?php endif; ?>
                <!-- <a href="<?= base_url("admin/$menu/cetak/$w->id_pengaduan") ?>" target="_blank" class="btn btn-warning"
                  title="Cetak">Cetak</a> -->
              </td>
            </tr>
            <?php endforeach; ?>
