...
class Pengaduan extends CI_Controller
{
	...
	function cetak_rab($id)
	{
		...
		$data['element'] .= "<h4 style='margin-top:-8px;' class='text-center'>DESA SIDOMULYO KECAMATAN WONOAYU</h4>";
		...
		$data['element'] .= '</table>';
		$data['element'] .= '<br><br>';
		$data['element'] .= '<div class="pull-right text-center" style="width: 100%;"><h5>Desa Sidomulyo, ' . date("d M Y") . '</h5></div>';
	...
	function cetak_lpj($id)
	{
		...
		$data['element'] .= "<h4 style='margin-top:-8px;' class='text-center'>DESA SIDOMULYO KECAMATAN BATU</h4>";
		$data['element'] .= "<h4 style='margin-top:-8px;' class='text-center'>TAHUN ANGGARAN " . TAHUN . "</h4>";
		$data['element'] .= "</div>";

		$data['element'] .= '<div style="margin-left:25px;">';
		$data['element'] .= '<h5>Yth. Kepala Desa <strong>Drs. Suharto</strong></h5>';
